...
Compare cost vs sustained QPS (top-100 unfiltered, f32 vectors) on LAION
100M across Turbopuffer and four Zilliz Cloud cluster sizes (Tiered 4/8
CU, Capacity 12/16 CU). Tiered 4 CU and 8 CU use index-version-10 reruns. For
QPS targets above a cluster's measured ceiling we mark **— (not
reachable)** rather than extrapolating.
...
| **8** ⭐ | $1.507 | **$1.488** ⭐ | $2.976 | $2.976 | $3.968 | <!-- crossover row -->
|  10 | $1.884 | **$1.488** | $2.976 | $2.976 | $3.968 |
|  57 | $10.738 | **$1.488** | $2.976 | $2.976 | $3.968 |
...
- **Region:** all systems tested in **AWS us-west-2**. Pricing quoted
  ...
  differ.
- Reference QPS measurements (unfiltered, k=100, f32 vectors):
...
## Results — LAION 100M unfiltered (f32)

### Monthly cost (720 hours of sustained QPS)

| QPS | Turbopuffer | Tiered 4 CU | Tiered 8 CU | Capacity 12 CU | Capacity 16 CU |
|----:|------------:|------------:|------------:|---------------:|---------------:|
|   1 | **$135.36** | $1,071.36 | $2,142.72 | $2,142.72 | $2,856.96 |
| **8** ⭐ | $1,084.99 | **$1,071.36** ⭐ | $2,142.72 | $2,142.72 | $2,856.96 |
|  10 | $1,356.48 | **$1,071.36** | $2,142.72 | $2,142.72 | $2,856.96 |
|  57 | $7,730.70 | **$1,071.36** | $2,142.72 | $2,142.72 | $2,856.96 |
|  58 | $7,866.32 | — (max 58) | **$2,142.72** | **$2,142.72** | $2,856.96 |
| 100 | $13,562.64 | — (max 58) | **$2,142.72** | **$2,142.72** | $2,856.96 |
| 114 | $15,461.41 | — (max 58) | **$2,142.72** | **$2,142.72** | $2,856.96 |
| 115 | $15,597.04 | — (max 58) | — (max 114) | **$2,142.72** | $2,856.96 |
| 400 | $54,249.84 | — | — | — (max 310) | **$2,856.96** |
...
- **QPS > 405** → Untested. Larger Capacity sizes or scaled-out Tiered
  required.
